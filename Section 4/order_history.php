...
//  Redirects guests to the login module in Section 1.
...
<head>
    ...
    <style>
        /* COMPONENT STYLING: High-contrast card container for readability. */
        .order-container { 
...
<body style="background-color: #f4f7f6;"> <?php include BASE_PATH . 'header.php'; ?>
    ...
    <div class="container mt-5">
        ...
        //  Checks if the user has any existing orders before rendering the data table.
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            while($row = mysqli_fetch_assoc($result)): 
                                ...
                                //  Assigns Bootstrap contextual classes based on the current order_status.
