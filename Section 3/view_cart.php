...
//  Provides functionality for item review, removal, and checkout initiation.
...
<head>
    ...
    <style>
        /* COMPONENT STYLING: High-contrast container for cart data */
        .cart-container { 
                    ...
                    <table class="table table-hover align-middle bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            foreach ($_SESSION['cart'] as $id => $qty): 
                                // SECURITY: Sanitize the session key before database lookup.
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-light text-dark border px-3 py-2"><?php echo $qty; ?></span>
                                </td>
                                <td class="text-center text-success fw-bold">RM <?php echo number_format($subtotal, 2); ?></td>
                                <td class="text-center pe-3">
                                    <a href="remove_cart.php?id=<?php echo $id; ?>" class="btn btn-sm btn-outline-danger rounded-pill px-3">
                                        Remove
                                    </a>
                                </td>
                            </tr>
